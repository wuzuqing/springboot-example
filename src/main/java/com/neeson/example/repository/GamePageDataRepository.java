 ...
 * @since 1.0.0
 */
public interface GamePageDataRepository extends JpaRepository<GamePageDataDto, Integer>, JpaSpecificationExecutor<GamePageDataDto> {


//    GameAccountTaskRecordDto findGameAccountDtoByAccountAndAreaAndFinishData(String account, String  area, String finishData);

    GamePageDataDto findGamePageDataDtoByFlagAndPage(String flag,String page);
}
